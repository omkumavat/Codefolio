        ...
        <div className="items-center mb-2 mt-2">
            <div className="space-y-1">
                <div className="flex justify-between items-center py-2 border-t border-gray-200">
                    <div
                        className={`w-1/3 text-right text-sm transition-colors ${data?.score1 > data?.score2
                    ...
                    <div
                        className={`w-1/3 text-left text-sm transition-colors ${data?.score1 < data?.score2
                                ? "font-bold text-green-600 animate-bounce"
                                : "text-gray-700"
                            }`}
                    >
