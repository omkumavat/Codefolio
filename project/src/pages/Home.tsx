    ...
    <>
      ...
      <div className="min-h-screen">
        <motion.section
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className={`min-h-screen flex items-center justify-center text-white relative overflow-hidden ${isDarkMode ? 'bg-gray-100' : 'bg-gradient-to-br from-white-500'
            }`}
        >
          ...
          <div className="container mx-auto px-4 z-10 text-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`px-8 py-3 rounded-full font-bold text-lg transition-colors transform ${isDarkMode
        ...
        <section className={`py-20 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
          <div className="container mx-auto px-4">
            <motion.h2
              ...
              className={`text-4xl font-bold text-center -mt-10 mb-16 ${isDarkMode ? 'text-white' : 'text-gray-900'
                }`}
            >
              Supported Platforms
            </motion.h2>
        ...
        <section className={`py-20 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="container mx-auto px-4">
            <motion.h2
              ...
              animate={inView ? { y: 0, opacity: 1 } : {}}
              className={`text-4xl font-bold text-center mb-10 ${isDarkMode ? 'text-white' : 'text-gray-900'
                }`}
            >
...
const PlatformCard = ({ title, icon, description, stats, isDarkMode }: any) => (
  <motion.div
    ...
    className={`p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-100 transform ${isDarkMode
...
const BenefitCard = ({ icon, title, description, isDarkMode }: any) => (
  <motion.div
    ...
    className={`p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ${isDarkMode
        ? 'bg-gray-800 text-white border border-white'
