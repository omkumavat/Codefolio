        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 mt-6"
            >
              Create Account
            </motion.button>
          </form>
