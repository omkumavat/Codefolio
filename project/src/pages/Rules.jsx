        ...
        },
        {
            ...
            content: (
                <div className="space-y-2">
                    ...
                    <div className="bg-gray-50 p-3 rounded-md">
                        <p className="font-semibold">Example:</p>
                        <p>If CodeChef solved = 100, CodeForces = 150, LeetCode = 200, and GeeksforGeeks = 50, then Total Problems Solved = 100 + 150 + 200 + 50 = 500.</p>
                    </div>
                </div>
            )
        },
