...
: React.FC<CircularProgressProps> = ({
  ...
  return (
    <div className="relative inline-flex flex-col items-center group">
      ...
      {/* Hover tooltip */}
      <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 rounded-lg text-sm whitespace-nowrap ${
        isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
      } shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-10`}>
        <div className="font-semibold">{count} / {total}</div>
