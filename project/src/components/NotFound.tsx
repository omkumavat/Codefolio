            ...
            <div className={`min-h-screen flex items-center justify-center p-4 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'
                ...
                <div className="text-center">
                    ...
                    >
                        <Link
                            to="/"
                            className={`inline-flex items-center space-x-2 px-6 py-3 rounded-lg ${isDarkMode
                    ...
                    <div className="absolute inset-0 -z-10 overflow-hidden">
                        {[...Array(20)].map((_, i) => (
                            <motion.div
                                ...
                                className={`absolute h-2 w-2 rounded-full ${isDarkMode ? 'bg-blue-500' : 'bg-blue-300'
                                    }`}
                            />
                        ))}
                    </div>
